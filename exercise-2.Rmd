...
**Go Loco** applies a set of explicit rules to translate words into **Go Loco**. Each word undergoes a _rearrangement_ and _addition_ transformation, but will differ slightly depending on the original word structure. 
